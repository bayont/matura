...
x_list=[]
y_list=[]
punkty = open("./punkty.txt")
for line in punkty:
    punkt = line.strip().split(" ") 
    x_list.append((int(punkt[0])))
    y_list.append((int(punkt[1])))
axes = Axes(xlim=(-10000,10000), ylim=(-10000,10000), figsize=(8,8))
axes.draw()
plt.scatter(x_list, y_list, s=1, zorder=10, facecolor="blue")
rect = pch.Rectangle((-5000,-5000), 10000, 10000, 0, facecolor='red', zorder=0)
